...
- Command Pattern, Command Center
- 对okHttp的封装 各种interceptor的应用
- 对Response的封装
- BaseActivity基类的设计,提供了各种需要的常用 的统一接口 比如
  - 对titleBar各个位置的封装
  - dialog，toast的封装
- （为什么要手动添加titleBar？）
- 手动实现了 独立 的 IM功能
- 对于BIO的应用， 各种守护以及重连以及崩溃修复机制
- 统一的设计风格
- 面向切面编程（拦截器）
- 图片选择器
...
- 没有基类Controller | Presenter 导致逻辑混合
- 没有doc
